                      ...
                      {projects.map((e, i) => {
                        ...
                        return (
                          <li className="block relative" key={i}>
                            <a onMouseEnter={()=> handleHover(i)} onMouseLeave={()=>handleHoverLeave()} href={e.url} target="_blank" rel="noopener noreferrer" className={`uppercase border-b border-white/30 w-full py-2 lg:py-[15px] flex items-end relative group transition-all ease-[cubic-bezier([0.83,0,0.17,1])] duration-[400ms] ${state}`}>
                      ...
                      <div className="max-w-[820px]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2">
                          ...
                          <div className="mb-8 lg:mb-12 col-span-1">
                            ...
                            <div className="flex">
                              <a href="mailto:hello@samgoddard.co.uk" className="flex leading-[1.1] text-2xl tracking-tight relative overflow-hidden group">
                          ...
                          <div className="mb-8 lg:mb-12 col-span-1">
                            ...
                            <span className="flex">
                              <a href="https://pangrampangram.com/products/migra" target="_blank" rel="noopener noreferrer" className="leading-[1.1] flex text-2xl tracking-tight relative group overflow-hidden">
                              ...
                              <a href="https://pangrampangram.com/products/editorial-new" target="_blank" rel="noopener noreferrer" className="leading-[1.1] flex text-2xl tracking-tight relative group overflow-hidden">
                                <span className="leading-[1.1] inline-block text-2xl tracking-tight relative"><span className="block absolute bottom-0 left-0 w-full h-[1px] translate-y-[-1px] bg-white/50"></span>Editorial New <span className="absolute inset-0 w-full h-full flex items-center justify-start"><span className="block transition-transform ease-in-out duration-[350ms] w-full h-[1px] bg-current translate-y-[-100%] translate-x-[-110%] lg:group-hover:translate-x-0"></span></span></span>
                              </a>
                            </span>
                          </div>
